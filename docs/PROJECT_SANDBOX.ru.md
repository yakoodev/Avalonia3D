...
Файл: [Avalonia3D.Sandbox/Program.cs](../Avalonia3D.Sandbox/Program.cs).
...
Файл: [Avalonia3D.Sandbox/Controls/SandboxModel3DControl.cs](../Avalonia3D.Sandbox/Controls/SandboxModel3DControl.cs).
...
Файл: [Avalonia3D.Sandbox/ViewModels/MainWindowViewModel.cs](../Avalonia3D.Sandbox/ViewModels/MainWindowViewModel.cs).
...
Файл: [Avalonia3D.Sandbox/Scenes/SceneCatalog.cs](../Avalonia3D.Sandbox/Scenes/SceneCatalog.cs).

Автоматически обнаруживает `*.gltf`/`*.glb` в [Assets/TestScenes](../Avalonia3D.Sandbox/Assets/TestScenes) рекурсивно.
...
Папка: [Avalonia3D.Sandbox/Assets/TestScenes](../Avalonia3D.Sandbox/Assets/TestScenes).
...
Скрипты из [tools/](../tools/) используют эту папку как source of truth для preflight/regression проверок.
